...
private String retrieveQuote() {
	...
	try {
		URL page = new URL("http://quote.yahoo.com/d/quotes.csv?s=" + ticker + "&f=slldltlclohgv&e=.csv");
		String line;
...
private void storeQuote(String data) {
	...
	try (Connection conn = DriverManager.getConnection(datasource, "user1", "USER1")) {
		
		Class.forName("org.apache.derby.jdbc.EmbeddedDriver");
		PreparedStatement prep2 = conn.prepareStatement(
				"INSERT INTO " +
				"USER1.STOCKS(TICKER, PRICE, DATE, CHANGE, LOW, " + 
