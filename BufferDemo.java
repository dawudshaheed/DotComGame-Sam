...
public class BufferDemo {
	public static void main (String[] arguments){
		...
		System.out.println("/nWriting: ");
		boolean success = as.writeStream();
		System.out.println("/nReading: ");
...
class ArgStream {
	...
	boolean writeStream() {
		try (FileOutputStream file = new FileOutputStream ("C:/Users/Administrator/Downloads/load.gif"); 
	...
	boolean readStream() {
		try (FileInputStream file = new FileInputStream("C:/Users/Administrator/Downloads/load.gif");
